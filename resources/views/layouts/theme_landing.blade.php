...
<head>
    ...
    <meta name="title" content="{{ !empty($setting['meta_keyword']) ? $setting['meta_keyword'] : ''}}">
    <meta name="description" content="{{ !empty($setting['meta_description']) ? $setting['meta_description'] : ''}}">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
              ...
              ">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card price-card price-3 wow animate__fadeInUp" data-wow-delay="0.6s" style="visibility: visible;animation-delay: 0.2s;animation-name: fadeInUp;">
                        <div class="card-body">
                            <span class="price-badge bg-primary">STARTER</span>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 text-end">
                    <p class="text-body"> {{ (Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :config('app.name', 'RotaGo-SaaS') }} {{date('Y')}}</p>
                </div>
            </div>
        </div>
    </section>
