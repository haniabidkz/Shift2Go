        ...
        <div class="dash-content">
            ...
            <div class="row">
                <div class="col-7 dashboard">
                    <div class="row">
                        <div class="col-lg-4 col-4 dashboard">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-0"><?php echo e(count($users)); ?></h3>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Laragon\www\shift2go\resources\views/super_admin.blade.php ENDPATH**/ ?>