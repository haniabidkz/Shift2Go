    ...
    <script>
        ...
        custdarklayout.addEventListener("click", function () {
            if (custdarklayout.checked) {
                ...
                // document.querySelector(".m-header > .b-brand > .logo-lg").setAttribute("src", "{{ $logos.'/'.(isset($company_logo) && !empty($company_logo)?$company_logo:'logo-light.png')}}");
            } else {
                document.querySelector("#main-style-link").setAttribute("href", "{{ asset('assets/css/style.css')}}");
                // document.querySelector(".m-header > .b-brand > .logo-lg").setAttribute("src", "{{ $logos.'/'.(isset($company_logos) && !empty($company_logos)?$company_logos:'logo-dark.png')}}");
            }
        });
