...
class IyziPayController extends Controller
{
    public function initiatePayment(Request $request)
    {
        ...
        try {
            ...
            $buyer->setName(explode(' ', $authuser->first_name)[0]);
            $buyer->setSurname(explode(' ', $authuser->last_name)[0]);
            ...
            $shippingAddress->setContactName($authuser->first_name);
            ...
            $billingAddress->setContactName($authuser->first_name);
