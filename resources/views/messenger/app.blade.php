                ...
                <div class="m-header m-header-messaging">
                    <nav>
                        <div style="display: inline-block;">
                            ...
                            @else
                                <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;background-image: url('{{ asset('/storage/'.config('chatify.user_avatar.folder').'/avatar.png') }}');"></div>
                            @endif
