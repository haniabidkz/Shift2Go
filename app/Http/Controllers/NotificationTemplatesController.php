...
{
    public function index($id = null, $lang = 'en',$type = 'slack')
    {
        if(\Auth::user()->type == 'super admin' || \Auth::user()->type == 'company')
        {
            ...
            $notification_templates = NotificationTemplates::where('type',$type)->get();

            return view('notification_templates.index', compact('notification_template','notification_templates','curr_noti_tempLang','languages','type','types'));
        }
        else
        {
