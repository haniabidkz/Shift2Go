...
class TimeSheetController extends Controller
{
    public function index(Request $request)
    {
        ...
        else
        {
            ...
            $timeSheets = Attendance::where([['attendances.created_by', $created_by],['attendances.clock_out','!=','00:00:00']])
            ...
            // $timeSheets = TimeSheet::where('time_sheets.created_by', $created_by)
            // ->join('attendances','time_sheets.user_id','=', 'attendances.user_id')
            // ->where([['attendances.clock_out','!=', Null],['attendances.clock_out','!=', '00:00:00']])
            // ->select('time_sheets.*','attendances.clock_in','attendances.clock_out','attendances.total_break_time','attendances.total_time')
            // ->get();
            //  dd($timeSheets);
