        ...
        if($plan)
        {
            ...
            // try{
                ...
                $post_params = array(
                    ...
                    'callback_url' => route('plan.coingate',[$request->plan_id,'amount='.$price,'payment_frequency='.$request->coingate_payment_frequency,'coupon_id='.$coupons_id]),
                    'cancel_url' => route('plan.coingate',[$request->plan_id]),
                    'success_url' => route('plan.coingate',[$request->plan_id,'amount='.$price,'payment_frequency='.$request->coingate_payment_frequency,'coupon_id='.$coupons_id]),
                    'title' => 'Plan #' . time(),
                );
