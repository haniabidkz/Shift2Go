...
//  dd($profile);
    ...
    {
        $profile = Profile::find($employee->id);
    ...
    public function set_pin(Request $request ,$id)
    {
        ...
        return view('employee.pin',compact('employee'));
    }
    ...
    public function addpin(Request $request ,$id)
    {
        ...
        if(!empty($employee) && !empty($request->pin))
        {
            ...
            $status = 'success';
            $msg = __('Pin Set Succsefully').$msg2;
        }
    ...
    public function employeePin($id)
    {
        ...
        return view('employee.pin-reset', compact('user', 'employee'));
    }

    public function employeePinReset(Request $request, $id){
        ...
        return redirect()->back()->with('success', __('Employee Pin successfully updated'));
