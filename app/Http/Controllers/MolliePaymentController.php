         ...
         try
            ...
            $payment = $mollie->payments->create(
                [
                    ...
                    "redirectUrl" => route('plan.mollie', [$request->plan_id,'TXNAMOUNT='.$price,'payment_frequency='.$request->mollie_payment_frequency,'coupon_id='.$coupons_id]),
                ]
            );
         }
         catch(\Exception $e){
               return redirect()->route('plan.index')->with('error', __('Invalid Amount'));
         }
